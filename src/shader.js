...
class GLShaderPass extends ShaderPass
{
    ...
    getShaderCode( includeBindings = true, entryName, entryCode )
    {
        ...
        // Add shader utils depending on bind group
        {
            ...
            {
                const utils = [
                    ...( hasTextureBindings ? GLShader.GLSL_TEXTURE_UTILS : [] ),
...
GLShader.GLSL_TEXTURE_UTILS = ``.split( "\n" );
...
void main()
{
    vec2 fragCoord = v_uv;// * iResolution + vec2f(0.5);
...
export { Shader, GLShader, ShaderPass, GLShaderPass };